...
import {logout } from '/home/bhubesh/react-clone-redux/src/features/userSlice.js'
    ...
    return (
        <div className = 'header'>
            ...
            <HeaderOption Icon = {HomeIcon} title ="Home"></HeaderOption>
                    ...
                    <HeaderOption Icon = {BusinessCenterIcon} title ="Business"></HeaderOption>
                    <HeaderOption Icon = {ForumIcon} title ="Message"></HeaderOption>
                    <HeaderOption Icon = {NotificationsIcon} title ="Notification"></HeaderOption>
                    <HeaderOption avatar title = 'me'  ></HeaderOption>
